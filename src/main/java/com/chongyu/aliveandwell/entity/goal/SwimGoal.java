package com.chongyu.aliveandwell.entity.goal;
    ...
    public void tick() {
        ...
        if (i > 100) {
            ...
            if (target != null) {
                ...
                BlockState blockState = this.squid.getWorld().getBlockState(BlockPos.ofFloored(this.squid.getX() + vec3d.x,
                        this.squid.getY() + vec3d.y, this.squid.getZ() + vec3d.z));
                FluidState fluidState = this.squid.getWorld().getFluidState(BlockPos.ofFloored(this.squid.getX() + vec3d.x,
                        this.squid.getY() + vec3d.y, this.squid.getZ() + vec3d.z));
