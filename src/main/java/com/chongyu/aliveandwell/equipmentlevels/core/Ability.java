...
public enum Ability {
    // 武器
    //火焰附加
//    FIRE("weapon", "passive", true, Formatting.RED, 0xFF5555, 1, 5),

    //击晕
    FROST("weapon", "passive", true, Formatting.AQUA, 0x55FFFF, 1, 5),
//    POISON("weapon", "passive", true, Formatting.DARK_GREEN, 0x00AA00, 1, 5),
    //凋零
    INNATE("weapon", "passive", true, Formatting.DARK_RED, 0xAA0000, 2, 5),
    //爆伤
//    BOMBASTIC("weapon", "passive", true, Formatting.GRAY, 0xAAAAAA, 3, 5),
    //致命一击
    ...
    //修复
//    ETHEREAL("weapon", "passive", true, Formatting.GREEN, 0x55FF55, 2, 5),
    //吸血
...
//    FROZEN("armor", "active", true, Formatting.AQUA, 0x55FFFF, 2, 5),
    //毒刺
    TOXIC("armor", "active", true, Formatting.DARK_GREEN, 0x00AA00, 2, 5),
    // passive
    //振奋
    BEASTIAL("armor", "passive", true, Formatting.DARK_RED, 0xAA0000, 2, 5),
//    REMEDIAL("armor", "passive", true, Formatting.LIGHT_PURPLE, 0xFF55FF, 2, 5),
    // 坚毅不催
    HARDENED("armor", "passive", true, Formatting.GRAY, 0xAAAAAA, 3, 5);
//    ADRENALINE("armor", "passive", true, Formatting.GREEN, 0x55FF55, 3, 5);
