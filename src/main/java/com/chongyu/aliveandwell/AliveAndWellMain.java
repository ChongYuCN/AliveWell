...
import com.chongyu.aliveandwell.dimensions.PortalInit;
import com.chongyu.aliveandwell.equipmentlevels.handle.ItemTooltipEventHandler;
import com.chongyu.aliveandwell.equipmentlevels.handle.LivingDeathEventHandler;
import com.chongyu.aliveandwell.equipmentlevels.handle.LivingHurtEventHandler;
import com.chongyu.aliveandwell.equipmentlevels.handle.LivingUpdateEventHandler;
import com.chongyu.aliveandwell.equipmentlevels.network.NetWorkHandler;
import com.chongyu.aliveandwell.flintcoppertool.init.EventsInit;
import com.chongyu.aliveandwell.hometpaback.Back;
import com.chongyu.aliveandwell.hometpaback.Homes;
import com.chongyu.aliveandwell.hometpaback.Tpa;
import com.chongyu.aliveandwell.miningsblock.BlockGroups;
import com.chongyu.aliveandwell.miningsblock.MiningEnchantment;
import com.chongyu.aliveandwell.miningsblock.MiningPlayers;
import com.chongyu.aliveandwell.miningsblock.logic.BlockProcessor;
import com.chongyu.aliveandwell.miningsblock.network.MiningNetwork;
import com.chongyu.aliveandwell.registry.*;
import com.chongyu.aliveandwell.registry.events.*;
import com.chongyu.aliveandwell.tablesandfurnaces.worklevel.CraftingIngredients;
import com.chongyu.aliveandwell.tablesandfurnaces.worklevel.FurnaceIngredients;
import com.chongyu.aliveandwell.util.AliveAndWellGroup;
...
import com.chongyu.aliveandwell.util.config.Config;
import com.chongyu.aliveandwell.world.OreGenBiome;
...
public class AliveAndWellMain implements ModInitializer {
    public static final String VERSION = "v3.1.10.1";//
//    public static final String VERSION = "v3.1.10-modrinth";//
...
//            randomManagerStorage.randomPosMap.clear();//清除缓存，避免新世界存档读取
