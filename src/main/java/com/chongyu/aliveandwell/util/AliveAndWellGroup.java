...
public class AliveAndWellGroup {
    public static void addGroup() {
        Registry.register(Registries.ITEM_GROUP, id("aliveandwell.group"), FabricItemGroup.builder()
                ...
                .displayName(Text.translatable("aliveandwell.group"))
...
//                    entries.add(BlockInit.HARD_GLASS);
//                    entries.add(BlockInit.HARD_GLASS_WHITE);
//                    entries.add(BlockInit.HARD_GLASS_ORANGE);
//                    entries.add(BlockInit.HARD_GLASS_MAGENTA);
//                    entries.add(BlockInit.HARD_GLASS_LIGHT_BLUE);
//                    entries.add(BlockInit.HARD_GLASS_YELLOW);
//                    entries.add(BlockInit.HARD_GLASS_LIME);
//                    entries.add(BlockInit.HARD_GLASS_PINK);
//                    entries.add(BlockInit.HARD_GLASS_GRAY);
//                    entries.add(BlockInit.HARD_GLASS_LIGHT_GRAY);
//                    entries.add(BlockInit.HARD_GLASS_CYAN);
//                    entries.add(BlockInit.HARD_GLASS_PURPLE);
//                    entries.add(BlockInit.HARD_GLASS_BLUE);
//                    entries.add(BlockInit.HARD_GLASS_BROWN);
//                    entries.add(BlockInit.HARD_GLASS_GREEN);
//                    entries.add(BlockInit.HARD_GLASS_RED);
//                    entries.add(BlockInit.HARD_GLASS_BLACK);
