package aliveandwell.aliveandwell.item.exitem;
...
public class ExItemMithril extends Item {
    public static final int MAX_STORAGE = 100000;
    public  int giveXP=1000;

    private final Random random = new Random();

    public ExItemMithril() {
        super(new Settings().maxCount(1).maxDamage(MAX_STORAGE).fireproof().group(ItemGroup.TOOLS));
    }
