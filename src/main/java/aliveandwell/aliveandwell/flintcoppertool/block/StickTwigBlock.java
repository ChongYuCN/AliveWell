package aliveandwell.aliveandwell.flintcoppertool.block;

import aliveandwell.aliveandwell.flintcoppertool.init.BlocksInit;
import aliveandwell.aliveandwell.flintcoppertool.utils.ModBlockTags;
...
public class StickTwigBlock extends Block {
    ...
    public StickTwigBlock() {
        super(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(0.15F, 0.15F).noCollision().collidable(false).offsetType(OffsetType.XZ));
    }
