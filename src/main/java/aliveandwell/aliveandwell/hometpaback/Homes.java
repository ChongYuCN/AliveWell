...
public class Homes {
    ...
    int homeInit(CommandContext<ServerCommandSource> ctx, String name) throws CommandSyntaxException {
        ...
        if(!player.world.getRegistryKey().equals(home.get().getDimID()) && (st1.equals(st2) && !st1.contains("minecells")) && !st1.contains("twilightforest")
                || !st1.equals(st2)
        ){
        ...
        TeleportUtils.genericTeleport(true, 3, player, () -> {
            ...
            if((player.totalExperience >= experience && player.world.getRegistryKey().equals(home.get().getDimID())  && (st1.equals(st2) && st1.contains("minecraft")))
            ...
            }else if (player.totalExperience < experience && player.world.getRegistryKey().equals(home.get().getDimID())){//
            ...
            } else if(!player.world.getRegistryKey().equals(home.get().getDimID()) && (st1.equals(st2) && !st1.contains("minecells")) && !st1.contains("twilightforest")
                    || !st1.equals(st2)
            ){
                ctx.getSource().sendFeedback(Text.translatable("aliveandwell.hometpaback.nosameworld").formatted(Formatting.RED), false);
            }
