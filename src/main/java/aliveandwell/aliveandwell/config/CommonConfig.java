...
public class CommonConfig {
    ...
    public JsonObject serialize(){
        ...
        entry.addProperty("desc3:", "最大死亡次数1-60");
        ...
        entry.addProperty("desc7:", "Modrinth版配置：是否添加FTB模组，默认false(需自己下载如下模组：ftbquests,itemfilters,ftblibrary,ftbteams)");
        entry.addProperty("canAddFTBMod", canAddFTBMod);
    ...
    public void deserialize(JsonObject data) {
        if (data == null) {
            ...
            try {
                ...
                canAddFTBMod  = data.get("aliveandwell").getAsJsonObject().get("canAddFTBMod").getAsBoolean();
