...
public class SleepingChatScreenMixin extends ChatScreen {
    ...
    public void init() {
        super.init();
        this.stopSleepingButton = this.addDrawableChild(new ButtonWidget(this.width / 2 - 12, this.height - 57, 24, 20, Text.translatable("multiplayer.stopSleeping"), button -> this.stopSleeping()));
